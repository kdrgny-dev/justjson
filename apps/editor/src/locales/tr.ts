...
export const tr: Record<string, string> = {
  ...
  'your-username': 'kullanıcı-adın',
  '{name} token': '{name} token',
  'Get a token': 'Token al',
  'Paste your {name} token first.': 'Önce {name} token’ını yapıştır.',
  'Connect {name} & publish': '{name} bağla ve yayınla',
  'Publish to {name}': "{name}'e yayınla",
  'Opens {name} in a popup to sign in, then deploys to your account.':
    '{name} giriş için açılır pencere açar, sonra kendi hesabına yükler.',
  'First build takes about a minute to go live.':
    'İlk derleme yayına girmek için yaklaşık bir dakika sürer.',
  'Your site was updated.': 'Siten güncellendi.',
  'Your site is live.': 'Siten yayında.',
  'Publishing cancelled.': 'Yayınlama iptal edildi.',
  'Publish to the web': "Web'e yayınla",
  'Publishing again updates the same site.': 'Tekrar yayınlamak aynı siteyi günceller.',
  Address: 'Adres',
  Republish: 'Yeniden yayınla',
  'Your site is live!': 'Siten yayında!',
  'That address is taken': 'Bu adres alınmış',
  '“{name}.netlify.app” is already in use. Pick another address.':
    '“{name}.netlify.app” zaten kullanımda. Başka bir adres seç.',
  'Try this address': 'Bu adresi dene',
  Commit: 'Commit et',
  ...
  'SEO / Meta': 'SEO / Meta',
  Other: 'Diğer',
  'Upload or drop image': 'Görsel yükle veya sürükleyip bırak',
  'Replace image': 'Görseli değiştir',
  'Remove image': 'Görseli kaldır',
  'Zoom preview': 'Büyük önizleme',
  'Enter URL': 'URL ile gir',
  'Upload file': 'Dosya yükle',
  'PNG, JPG, WebP or SVG': 'PNG, JPG, WebP veya SVG',
  Duplicate: 'Çoğalt',
  'Duplicate row': 'Satırı çoğalt',
  'Move up': 'Yukarı taşı',
  'Move down': 'Aşağı taşı',
  'Remove row': 'Satırı sil',
  'Add new item': 'Yeni satır ekle',
  Desktop: 'Masaüstü',
  Tablet: 'Tablet',
  Mobile: 'Mobil',
  'Publish to site': 'Değişiklikleri Siteye Gönder',
  'Sync content': 'İçeriği Eşitle',
  'Publishing in progress': 'Siteye aktarılıyor…',
  'Step 1: Gathering changes…': '1. Değişiklikler toplanıyor…',
  'Step 2: Packaging content…': '2. İçerik paketleniyor…',
  'Step 3: Deploying to site…': '3. Siteye gönderiliyor…',
  'Published successfully!': 'Başarıyla yayınlandı!',
  'AI Translation': 'Yapay Zeka Çeviri',
  'Translate into other languages': 'Diğer dillere otomatik çevir',
  'Select all': 'Tümünü seç',
  'Clear selection': 'Seçimi temizle',
  'Translate & Save': 'Çevir ve Kaydet',
  'Source language': 'Kaynak dil',
  'Target languages': 'Hedef diller',
  'Overwrite existing translation': 'Var olan çevirilerin üzerine yaz',
  'Words': 'kelime',
  'min read': 'dk okuma',
}
